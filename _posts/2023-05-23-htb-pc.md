...
SimpleApp.getInfo
```
Vemos que existen 3 metodos, esos metodos tiene mas definiciones por dentro, que son las estructuras protobuf asi que usaremos el comando:
...
Ahora si queremos ver el codigo de un protobuf usamos el comando:

```
grpcurl -plaintext 10.129.93.244:50051 describe LoginUserRequest
```

Y podemos ver ese protobuf:
...
Y vemos que esta esperando por un nombre y una contraseña.
...
(la idea de la solucion no es mia, gracias al usuario de HTB que me dio la idea)
