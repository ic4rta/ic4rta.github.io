...
Kerberoasting se aprovecha de la obtencion de **TGS**, es decir, cuando un usuario intenta acceder a un servicio, se entrega su **TGT** al **KDC** con una solicitud de un ticket para ese servicio, entonces el **KDC** verifica si el **TGT** es valido, y si lo es, le entrega un ticket de servicio, entonces si nosotros comprometemos a un usuario valido, podemos solicitar los demas **TGS** de los usuario que tengan un **SPN** en un Domain Controller
