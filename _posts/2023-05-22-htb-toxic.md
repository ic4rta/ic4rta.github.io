---
title: HackTheBox Toxic - LFI to RCE via Log Poisoning y Insegure Deserialization en PHPSESSID
author: c4rta
date: 2023-05-22
...
(este no es un post que explica esta vulnerabilidad, pero puedes leer [aqui](https://redfoxsec.com/blog/insecure-deserialization-in-php/))

## Local FIle Inclusion

(tampoco este es un post que explica LFI, pero puedes leer un post de mi compa [droix3d](https://droix3d.github.io/posts/LocalFileInclusion/) que lo explica muy bien)
...
![](/assets/img/commons/toxic/1.png)
...
![](/assets/img/commons/toxic/2.png)
...
![](/assets/img/commons/toxic/3.png)
...
![](/assets/img/commons/toxic/4.png)
...
![](/assets/img/commons/toxic/5.png)
...
![](/assets/img/commons/toxic/6.png)

Joder, esto si es RCE  🚬

Eso ha sido todo, gracias por leer ❤

![](/assets/img/commons/toxic/waifu.gif)