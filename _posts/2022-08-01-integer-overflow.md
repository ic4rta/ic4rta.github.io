...
excerpt: "En este articulo veremos como funciona y como realizar un Integer Overflow"
date: 2022-08-01
classes: wide
header:
...
![](/assets/images/integer-overflow/integer.jpg)
...
Para este ejercico voy a tomar de ejemplo una variable ```signed int``` de 32 bits que su valor maximo es ```2147483647```, voy a ingresar ese valor para indicar lo que dije en el parrafo de arriba

![](/assets/images/integer-overflow/signed1.png)
...
![](/assets/images/integer-overflow/signed2.png)
...
![](/assets/images/integer-overflow/binario.png)
...
![](/assets/images/integer-overflow/radare1.png)

Ahora me movere a la parte donde el programa tome nuestro primer input

![](/assets/images/integer-overflow/radare2.png)
...
![](/assets/images/integer-overflow/radare3.png)
...
![](/assets/images/integer-overflow/radare5.png)
...
![](/assets/images/integer-overflow/radare6.png)
...
![](/assets/images/integer-overflow/radare7.png)
...
![](/assets/images/integer-overflow/radare9.png)
