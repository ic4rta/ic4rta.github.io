...
excerpt: "En este articulo veremos un ejemplo muy simple de como sobreescribir GOT aprovechandonos de una vulnerabilidad format string"
date: 2022-07-30
classes: wide
header:
...
## Contenido
* Global Offset Table (GOT) y Procedure Linked Table (PLT)
...
![](/assets/images/formatString-got/elf.png)
...
![](/assets/images/formatString-got/got%26plt.png)
...
![](/assets/images/formatString-got/format1.png)
...
![](/assets/images/formatString-got/format2.png)
