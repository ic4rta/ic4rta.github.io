var store = [{
        ...
        "teaser":"http://localhost:4000/assets/images/bof-stack-based/waifu.png"},{
        "title": "Format string",
        ...
        "teaser":"http://localhost:4000/assets/images/format-string/waifu.png"},{
        ...
        "teaser":"http://localhost:4000/assets/images/picoCTF-hurry/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/ret2libc/waifu.png"},{
        ...
        "teaser":"http://localhost:4000/assets/images/formatString-got/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/imaginaryCTF-date2/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/integer-overflow/waifu.png"},{
        ...
        "teaser":"http://localhost:4000/assets/images/leak-stack-canary/waifu.gif"},{
        ...
        "teaser":"http://localhost:4000/assets/images/bypass-aslr/waifu.gif"},{
        ...
        "teaser":"http://localhost:4000/assets/images/prng/waifu.webp"},{
        ...
        "teaser":"http://localhost:4000/assets/images/introduccion/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/ret2win/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/web-gaunlet/waifu.jpg"},{
        ...
        "teaser":"http://localhost:4000/assets/images/tamu-pwn1/waifu.webp"}]
